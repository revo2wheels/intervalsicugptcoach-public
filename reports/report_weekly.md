...
[FINALIZER] Markdown-only return OK — len=5531, ctx_keys=81
✅ Renderer source: Tier-2 enforced totals (canonical dataset)
[FINALIZER] Enforcing markdown-only return (season-safe mode)
[FINALIZER] Markdown-only return OK — len=5531, ctx_keys=81
```
...
**Athlete:** Clive King
**Period:** 2025-11-27 → 2025-12-03
**Timezone:** Europe/Zurich
**Generated:** 2025-12-03T11:02:31.131175
...
| Strain | 19.9 | 🟢 optimal | Product of load × monotony; >3500 signals potential overreach. |
...
| ZQI | 3.7 | 🟠 moderate | Zone Quality Index (%) 5-15 high-intensity time is normal <3% too easy, >20% too intense or erratic pacing. |
| FatOxEfficiency | 0.689 | 🟢 optimal | 0.4–0.8 means balanced fat oxidation; lower = carb dependence. |
| Polarisation | 0.9 | 🟢 polarised | 0.75–0.9 matches Seiler 80/20 distribution; <0.7 = too intense. |
| FOxI | 68.9 | 🟠 moderate | FatOx index %; higher values mean more efficient aerobic base. |
| CUR | 31.1 | 🟢 optimal | Carbohydrate Utilisation Ratio; 30-80 balanced metabolic use. |
| GR | 1.84 | 🟢 optimal | Glucose Ratio; >2 indicates excess glycolytic bias. |
...
- Rest Days: 2
- Resting HR: 43.3 bpm
- HRV: 43.0 ms (↓ declining (-6.0 ms), prev 49.0 ms)
- Fatigue: 1.5/5
- Stress: 1.8/5
- Readiness: nan/5
- ATL: 84.76 · CTL: 89.78 · TSB: 5.02
...
11. ✅ Strain (19.9) — If Strain > 3000, monitor for signs of overreach and consider more rest or deloading. If Strain > 3500, consider reducing volume or intensity temporarily.
12. ✅ FatOxEfficiency (0.689) — If FatOxEfficiency is low (<0.6), focus on improving aerobic base with longer, low-intensity efforts.
13. ✅ CUR (31.1) — If CUR is outside the green zone (30-70), adjust carbohydrate intake and fueling strategy to ensure balanced metabolic use during long sessions.
14. ✅ GR (1.84) — If GR exceeds 2.0, focus on reducing glycolytic intensity and increase aerobic work. Ensure sufficient recovery to avoid over-reliance on carbs.
...
**Cycling Totals:** 5.53 h · 195.9 km · 326 TSS · 5 sessions**
**All Activities:** 6.84 h · 202.3 km · 340 TSS · 6 sessions**
_Note: CTL/ATL/TSB values include **all activities**._

---
✅ **Audit Completed:** 2025-12-03T11:02:31.136095
