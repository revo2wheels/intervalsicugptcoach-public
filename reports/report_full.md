...
🧮 Tier-1 canonical totals = 13.94 h | 640 TSS
📋 Tier-1 visible subset totals = 13.94 h | 339.6 km | 640 TSS (10 events)
🪶 Tier-1 serialization complete: 10 records
...
0 2025-11-11  91.317184   91.207280
1 2025-11-11  91.317184   91.207280
2 2025-11-11  91.317184   91.207280
3 2025-11-09  92.957780  101.175865
...
[DEBUG-OUTLIER] mean TSS=64.0, std=56.8, threshold=85.2
...
🧮 Tier-2: Σ(moving_time)=50173s → 13.94h (Intervals seconds source)
...
[T1] Wellness date range: 2025-11-06 → 2025-11-12
✅ Wellness alignment check passed.
[T2-ACWR] EWMA model applied → acute=117.12, chronic=94.55, ratio=1.24
[DEBUG] Derived metrics synced: {'ACWR': 0.0, 'Monotony': 0.0, 'Strain': 0.0, 'Polarisation': 0.0, 'RecoveryIndex': 0.0}
[DEBUG-T2X] post-extended load_metrics: {'CTL': {'value': 91.4, 'status': 'ok'}, 'ATL': {'value': 92.12, 'status': 'ok'}, 'TSB': {'value': -0.72, 'status': 'ok'}, 'ACWR': {'value': 1.24, 'status': 'ok'}, 'Monotony': {'value': np.float64(3.5), 'status': 'ok'}, 'Strain': {'value': np.float64(2240.0), 'status': 'ok'}, 'Polarisation': {'value': 0.699, 'status': 'ok'}, 'RecoveryIndex': {'value': np.float64(0.3), 'status': 'ok'}}
[T2-ACTIONS] Integrated derived metrics:
{'ACWR': {'value': 1.24, 'status': 'optimal', 'icon': '🟢'}, 'Monotony': {'value': np.float64(3.5), 'status': 'out of range', 'icon': '🔴'}, 'Strain': {'value': np.float64(2240.0), 'status': 'optimal', 'icon': '🟢'}, 'FatigueTrend': {'value': np.float64(0.609), 'status': 'out of range', 'icon': '🔴'}, 'ZQI': {'value': 6.8, 'status': 'optimal', 'icon': '🟢'}, 'FatOxEfficiency': {'value': 0.536, 'status': 'optimal', 'icon': '🟢'}, 'Polarisation': {'value': 0.699, 'status': 'borderline', 'icon': '🟠'}, 'FOxI': {'value': 53.6, 'status': 'optimal', 'icon': '🟢'}, 'CUR': {'value': 46.4, 'status': 'optimal', 'icon': '🟢'}, 'GR': {'value': 0.87, 'status': 'optimal', 'icon': '🟢'}, 'MES': {'value': np.float64(21.0), 'status': 'optimal', 'icon': '🟢'}, 'RecoveryIndex': {'value': np.float64(0.3), 'status': 'out of range', 'icon': '🔴'}, 'ACWR_Risk': {'value': '✅', 'status': 'no data', 'icon': '⚪'}, 'StressTolerance': {'value': np.float64(6.4), 'status': 'optimal', 'icon': '🟢'}}
...
🔎 Render pre-flight — totals by source:
   df_events Σmoving_time = 13.936944444444444
   df_events Σicu_training_load = 640
   eventTotals(hours) = 13.94
...
[CANONICAL PROPAGATION] hours=13.94, tss=640
[LOCK] Tier-2 canonical totals re-locked before render
[TRACE-DF] Σ df_events(moving_time)/3600 = 13.94 h
[TRACE-DF] Σ df_events(icu_training_load) = 640
[TRACE-CONTEXT] totalHours (context) = 13.94
[TRACE-CONTEXT] totalTss (context) = 640
[TRACE-CONTEXT] eventTotals(hours,tss) = 13.94, 640
...
[TRACE-RENDER-ENTRY] totalHours = 13.94
[TRACE-RENDER-ENTRY] totalTss   = 640
...
[TRACE-HEADER] ctx.totalHours = 13.94
[TRACE-HEADER] ctx.totalTss   = 640
...
load_metrics post-render: {'CTL': {'value': 91.4, 'status': 'ok'}, 'ATL': {'value': 92.12, 'status': 'ok'}, 'TSB': {'value': -0.72, 'status': 'ok'}, 'ACWR': {'value': 1.24, 'status': 'ok'}, 'Monotony': {'value': 3.5, 'status': 'ok'}, 'Strain': {'value': 2240.0, 'status': 'ok'}, 'Polarisation': {'value': 0.699, 'status': 'ok'}, 'RecoveryIndex': {'value': 0.3, 'status': 'ok'}, 'totalHours': 13.94, 'totalTss': 640}
------------------------------------------------------------
...
================================================================================
[TRACE-POST-RENDER-CHECK] header={'title': 'Weekly Training Report', 'framework': 'Unified_Reporting_Framework_v5.1', 'athlete': '90 avec Jacques', 'period': '2025-11-06 → 2025-11-12', 'timestamp': '2025-11-12T14:42:08.285158', 'discipline': 'cycling'}
...
[PATCH] header rebuilt for schema compliance: {'title': 'Weekly Training Report', 'framework': 'Unified_Reporting_Framework_v5.1', 'athlete': '90 avec Jacques', 'period': '2025-11-06 → 2025-11-12', 'timestamp': '2025-11-12T14:42:08.285158', 'discipline': 'cycling', 'Total Hours': '13.94 h', 'Total Load (TSS)': 640}
...
[TRACE-FINAL] totalHours = 13.94
[TRACE-FINAL] totalTss   = 640
[TRACE-FINAL] eventTotals(hours,tss) = 13.94 640
[TRACE-FINAL] summary_patch = {'totalHours': np.float64(13.94), 'totalTss': 640, 'eventCount': 10, 'period': '2025-11-06 → 2025-11-12', 'variance': 0.0, 'zones': {}}
...
**Generated:** 2025-11-12T14:42:08.284229
...
|:-- |:-- |:-- |:--|
| ACWR | 1.24 | 🟢 optimal | EWMA Acute:Chronic Load Ratio — compares 7-day vs 28-day weighted loads. 0.8–1.3 = productive training, <0.8 = recovery or detraining, >1.5 = overload/injury risk. |
| Monotony | 3.5 | 🔴 out of range | 1–2 shows healthy variation; >2.5 means repetitive stress pattern. |
| Strain | 2240.0 | 🟢 optimal | Product of load × monotony; >3500 signals potential overreach. |
| FatigueTrend | 0.609 | 🔴 out of range | 0±0.2 indicates balance; positive trend means accumulating fatigue. |
| ZQI | 680.0 | 🟢 optimal | Zone Quality Index (%) 5-15 high-intensity time is normal <3% too easy, >20% too intense or erratic pacing. |
| FatOxEfficiency | 0.536 | 🟢 optimal | 0.4–0.8 means balanced fat oxidation; lower = carb dependence. |
| Polarisation | 0.699 | 🟠 borderline | 0.75–0.9 matches Seiler 80/20 distribution; <0.7 = too intense. |
| FOxI | 53.6 | 🟢 optimal | FatOx index %; higher values mean more efficient aerobic base. |
| CUR | 46.4 | 🟢 optimal | Carbohydrate Utilisation Ratio; 30-80 balanced metabolic use. |
| GR | 0.87 | 🟢 optimal | Glucose Ratio; >2 indicates excess glycolytic bias. |
| MES | 21.0 | 🟢 optimal | Metabolic Efficiency Score; >20 is good endurance economy. |
| RecoveryIndex | 0.3 | 🔴 out of range | 0.6–1.0 means recovered; <0.5 = heavy fatigue. |
| ACWR_Risk | ✅ | ⚪ no data | Used internally for stability check. |
| StressTolerance | 6.4 | 🟢 optimal | 2–8 indicates sustainable training strain capacity. |
...
| Monotony | 3.5 | ok |
| Strain | 2240.0 | ok |
| Polarisation | 0.699 | ok |
| RecoveryIndex | 0.3 | ok |
| totalHours | 13.94 | ✅ |
| totalTss | 640 | ✅ |
...
3. ⚠ Apply 30–40 % deload (Friel microcycle logic).
...
8. ⚠ Polarisation low (70%) — increase Z1–Z2 share toward ≥70 %.
9. ⚠ Recovery Index poor (0.30) — insert deload or reduce intensity.
10. ---
11. 📊 Metric-based Feedback:
12. ✅ ACWR (1.24) — Guides short-term vs. chronic load balance adjustments.
13. ⚠ Monotony (3.5) — Used to determine need for rest or deload variation.
14. ✅ Strain (2240.0) — Informs total stress tolerance and recovery planning.
15. ⚠ FatigueTrend (0.609) — Signals need for load stabilization or downshift.
16. ✅ ZQI (6.8) — Represents proportion of high-intensity time; 5–15 % indicates balanced intensity distribution.
17. ✅ FatOxEfficiency (0.536) — Drives aerobic base and metabolic conditioning feedback.
18. ⚠ Polarisation (0.699) — Determines intensity mix correction (Seiler balance).
19. ✅ FOxI (53.6) — Helps assess Zone 2 progression and fat adaptation.
20. ✅ CUR (46.4) — Advises on fueling strategy and carbohydrate dependency.
21. ✅ GR (0.87) — Glucose Ratio; gauges glycolytic bias — higher values indicate heavy carbohydrate reliance.
22. ✅ MES (21.0) — Summarizes efficiency adaptation response.
23. ⚠ RecoveryIndex (0.3) — Influences rest day scheduling and microcycle tapering.
24. ✅ StressTolerance (6.4) — Reflects sustainable strain capacity; 2–8 indicates robust adaptation to training load.
...
---
✅ **Audit Completed:** 2025-11-12T14:42:08.285139
